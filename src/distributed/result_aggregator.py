...
class ResultAggregator:
    ...
    async def add_result(self, result: TestResult) -> None:
        ...
        async with self._aggregation_lock:
            ...
            logger.info(f"Added result for test {result.test_id} from node {result.node_id}")
    ...
    def get_test_summary(self, test_id: str) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "last_run": max(r.timestamp for r in results).isoformat() if results else None
        }
    ...
    def get_overall_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "last_run": max(r.timestamp for r in all_results).isoformat() if all_results else None
        }
        ...
        for test_id, results in self.results.items():
            ...
            if failed_results:
                failed.append({
                    ...
                    "last_failure": max(r.timestamp for r in failed_results).isoformat(),
    ...
    def get_node_performance(self) -> Dict[str, Dict[str, Any]]:
        ...
        for node_id, stats in node_stats.items():
            ...
            stats["success_rate"] = (stats["passed"] / stats["total_tests"]) * 100 if stats["total_tests"] else 0
            del stats["durations"]
