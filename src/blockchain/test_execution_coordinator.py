...
class TestExecutionCoordinator:
    ...
    def accept_test_job(self, test_id: str) -> str:
        ...
        transaction = self.contract.functions.acceptTestJob(test_id).build_transaction(
            {
                "nonce": nonce,
                "gas": 200000,
                "gasPrice": self.w3.eth.gas_price,
    ...
    def complete_test_job(
        self, test_id: str, success: bool, result_data: Dict[str, Any]
    ) -> str:
        """
    ...
    def add_verifier(self, test_id: str) -> str:
        ...
        transaction = self.contract.functions.addVerifier(test_id).build_transaction(
            {
                "nonce": nonce,
                "gas": 200000,
                "gasPrice": self.w3.eth.gas_price,
