...
class ReportGenerator:
    ...
    def generate_html_report(self, test_results: List[Dict], metrics: Dict, 
                           node_stats: Dict, output_file: Optional[str] = None) -> str:
    ...
    def generate_json_report(self, test_results: List[Dict], metrics: Dict,
                           node_stats: Dict, output_file: Optional[str] = None) -> str:
    ...
    def generate_csv_report(self, test_results: List[Dict], output_file: Optional[str] = None) -> str:
    ...
    def generate_summary_report(self, test_results: List[Dict], metrics: Dict,
                              node_stats: Dict, output_file: Optional[str] = None) -> str:
