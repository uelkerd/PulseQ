...
class MetricsVisualizer:
    ...
    def create_performance_heatmap(self, metrics_data: List[Dict[str, Any]]) -> go.Figure:
    ...
    def create_latency_distribution(self, metrics_data: List[Dict[str, Any]]) -> go.Figure:
    ...
    def create_performance_radar(self, current_metrics: Dict[str, float], baseline_metrics: Dict[str, float]) -> go.Figure:
        """Create a radar chart comparing current vs baseline performance."""
        metrics = ['cpu_percent', 'memory_percent', 'network_latency', 'js_heap_used', 'dom_depth']
    ...
    def create_resource_usage_gauge(self, current_value: float, threshold: float, title: str) -> go.Figure:
    ...
    def create_performance_summary(self, metrics_data: List[Dict[str, Any]]) -> go.Figure:
