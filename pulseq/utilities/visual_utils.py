...
class VisualTester:
    ...
    def __init__(self, screenshots_dir: str = "screenshots"):
        ...
        logger.info(f"Initialized VisualTester with screenshots directory: {screenshots_dir}")
    ...
    def compare_screenshots(
        ...
        score, diff = structural_similarity(
            current_gray, baseline_gray, full=True
        )
        ...
        diff_path = None
        if score < threshold:
            diff_path = str(Path(current_screenshot).with_name(
