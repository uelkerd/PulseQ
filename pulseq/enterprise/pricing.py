...
class PricingManager:
    ...
    def __init__(self):
        ...
        self.pricing = {
            FeatureTier.FREE: {"monthly": 0, "annual": 0},
            FeatureTier.PREMIUM: {"monthly": 99, "annual": 990},
            FeatureTier.ENTERPRISE: {"monthly": 499, "annual": 4990},
            FeatureTier.MILITARY: {"monthly": 999, "annual": 9990},
        }
    ...
    def generate_quote(
        self, tier: FeatureTier, quantity: int = 1, period: str = "monthly"
    ) -> Dict[str, Any]:
...
class LicenseManager:
    ...
    def check_feature_access(self, license_data: Dict[str, Any], feature: str) -> bool:
