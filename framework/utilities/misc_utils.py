...
class MiscUtils:
    ...
    def compare_images(img1_path, img2_path, threshold=0.1):
        ...
        try:
            ...
            error_msg = ("Image comparison requires additional packages. "
        ...
        try:
            ...
            logger.debug(f"Image similarity: {similarity:.4f}, threshold: {threshold}, similar: {is_similar}")
    ...
    def extract_text_from_image(image_path):
        ...
        try:
            ...
            error_msg = ("OCR requires additional packages. "
